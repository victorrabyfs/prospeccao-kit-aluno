...
export function normalizarTelefone(bruto) {
  ...
  // Celular antigo, sem o nono dígito (link de WhatsApp ainda vem assim): 55 + DDD + 8 dígitos começando
  // em 6 a 9. Fixo começa em 2 a 5 e fica como está.
  if (d.length === 12 && /^55[1-9][1-9][6-9]/.test(d)) d = `${d.slice(0, 4)}9${d.slice(4)}`;
