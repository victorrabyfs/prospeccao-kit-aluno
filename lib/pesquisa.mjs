...
const GENERICAS = new Set(['clinica', 'clinicas', 'odontologia', 'odontologica', 'odontologico', 'odontologicas', 'odontologicos', 'odonto', 'consultorio', 'dentista',
  'dr', 'dra', 'centro', 'saude', 'estetica', 'integrada', 'integrado', 'especializada', 'especializado', 'espaco', 'instituto', 'consultorio', 'odontologicos', 'energia', 'solar', 'de', 'da', 'do', 'das', 'dos', 'e', 'em', 'ltda', 'me', 'the']);
